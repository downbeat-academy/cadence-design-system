...
function Arrow(_a) {
    ...
    return (React.createElement(IconWrapper, { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', size: size, color: color, direction: direction, css: {
            '> *': {
                fill: "" + color,
            }
        } }, iconRender(icon)));
...
export { Arrow, Button, Flex, Grid, H1, H2, H3, H4, H5, H6, Icon, Mega, Paragraph, SocialIcon, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
